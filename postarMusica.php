...
<head>
    ...
    <link rel="stylesheet" href="styles/styleAudioPlayer.css">
    <link rel="stylesheet" href="styles/styleInputTag.css">
    <link rel="stylesheet" href="styles/stylePostarMusica.css">
    ...
    <title>INBRIE - Postar música</title>
</head>
<body class="preload" id="preloadcontainer">
    ...
    <div class="post-container">
        <img class="logo-music" src="imagens/musicaIcon.png">
        <h1>Música</h1>
        <p>Cante um cover, toque sua melodia, equalize seus sentimentos. <br> Publique suas músicas!</p>
            ...
            if(isset($_SESSION['post_ok'])){
                ...
                <div class='msg-box'>
                    ...
                    <div class='text-box sucess-box'>
                        ...
                        <h2>Obra publicada com sucesso. <br> Você pode visualizá-la <a href=musica.php?postID=$lastID> aqui </a>.</h2>
                    </div>
                </div>
                ";
        ...
        ?>
            <form method="POST" action="zActionsPHP/musicaAction.php" enctype="multipart/form-data">
                <label for="titleinput">Título</label>
                <input type="text" name="titleinput" class="input-normal" id="titleinput" placeholder="Escreva aqui o título do single / EP / albúm.">

                <label for="descinput">Descrição</label>
                <textarea type="text" name="descinput" class="input-normal" id="descinput" placeholder="Escreva aqui informações adicionais. Pode ser a equipe participante, software/equipamento utilizado."></textarea>

                <label>Tipo</label>
                <select name="typeinput" id="typeinput" class="input-normal">
                ...
                <label>Gênero</label>
                <select name="genreinput" id="genreinput" class="input-normal">
                ...
                <button class="new-music">
                    <input type="file" name="new-audio" id="new-audio" class="input-newmusic" accept="audio/*">
    ...
    <script src="scripts/scriptAudioPlayer.js"></script>
    <script src="scripts/novaFaixa.js"></script>
