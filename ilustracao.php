...
<body class="preload" id="preloadcontainer">
    <?php
        ...
        $postID = $_GET['postID'];
        $sql = "SELECT id_usuario, postTitulo, postDescricao FROM posttipoilustracao WHERE postID = $postID";
    ...
    <div class="publicacao-container">
        ...
        <div class="row-content-container">
            <div class="content-container">
                ...
                if(isset($_SESSION['usuarioID'])){ 
                    if($usuarioLogadoID == $id_usuario){
                        echo "<form method='POST' action='zActionsPHP/excluirPost/excluirIlustracao.php' class='btn-excluir-post'>
                ...
                <div class="img-content-container">
                    <?php
                        $sql = "SELECT conteudoIndice, conteudoDiretorio FROM postconteudoilustracao WHERE id_ilustracaoPost = $postID ORDER BY conteudoIndice ASC";
                        $result = mysqli_query($conexao, $sql);
                        while($row = mysqli_fetch_assoc($result)){
                ...
                <div class="tags-container">
                    <?php
                        $sql = "SELECT tag FROM posttagilustracao WHERE id_ilustracaoPost = $postID";
                        $result = mysqli_query($conexao, $sql);
                        while($row = mysqli_fetch_assoc($result)){
                            $tag = $row['tag'];
                            echo "
                ...
                <div class="info-post">
                    <?php
                        $sql = "SELECT COUNT(*) AS numLikes FROM postcurtidailustracao WHERE id_ilustracaoPost = $postID AND curtidaTipo = 1";
                        $result = mysqli_query($conexao, $sql);
                        while($row = mysqli_fetch_assoc($result)){
                            $numLikes = $row['numLikes'];
                        }

                        $sql = "SELECT COUNT(*) AS numDeslikes FROM postcurtidailustracao WHERE id_ilustracaoPost = $postID AND curtidaTipo = 0";
                        $result = mysqli_query($conexao, $sql);
                        while($row = mysqli_fetch_assoc($result)){
            ...
            <div class="buttons-container">
                <form method="POST" action="zActionsPHP/like/likeIlustracao.php">
        ...
        if(isset($_SESSION['usuarioID'])){ 
                ...
                <form method="POST" action="zActionsPHP/like/deslikeIlustracao.php">
                <input type="hidden" id="usuarioLogadoID" name="usuarioLogadoID" style="display: none;" value="<?php 
        if(isset($_SESSION['usuarioID'])){  echo $usuarioLogadoID; }?>">
                <input type="hidden" id="postID" name="postID" style="display: none;" value="<?php echo $postID; ?>">
                <?php
        if(isset($_SESSION['usuarioID'])){ 
            ...
            <?php
                $sql = "SELECT COUNT(*) AS numComment FROM postcomentarioilustracao WHERE id_ilustracaoPost = $postID";
                $result = mysqli_query($conexao, $sql);
                while($row = mysqli_fetch_assoc($result)){
            ...
            <div class="comments-container">
                ...
                <div class="insert-comment-container">
                    ...
                    <form action="zActionsPHP/postarComentario/postarComentarioIlustracao.php" method="post" class="send-comment-container">
                    <?php
                    if(isset($_SESSION['usuarioID'])){ 
                ...
                <?php
                    $sql = "SELECT usuario.usuarioFotoPerfil, usuario.usuarioNome, postcomentarioilustracao.comentarioID, postcomentarioilustracao.comentarioConteudo, postcomentarioilustracao.comentarioData FROM usuario, postcomentarioilustracao WHERE usuario.usuarioID = postcomentarioilustracao.id_usuario AND postcomentarioilustracao.id_ilustracaoPost = $postID  ORDER BY comentarioData DESC;";
                    $result = mysqli_query($conexao, $sql);
                    if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class='sended-comment-container'>
                                ...
                                <form method='get' class='send-comment-container' action='zActionsPHP/excluirComentario/excluirComentarioilustracao.php?comentarioID='$comentarioID'&postID='$postID'>
